...
namespace MediaProcessor
{
    public class YouTubeMediaHandler
    {
        ...
        public static async Task<SearchListResponse> fetchChannelVideosByAPI(string ChannelID, DateTime fromDate)
        {
            ...
            try
            {
                ...
                //searchRequest.PublishedAfter = fromDate;
        ...
        public async void YouTubeMediaMain(string channelID)
        {
            ...
            SearchListResponse playlistItemListResponse = await fetchChannelVideosByAPI(channelID, new DateTime(2024, 12, 1));
